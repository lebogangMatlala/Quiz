...
import { HistoryFourthPage } from '../history-fourth/history-fourth';
import { HomePage } from '../home/home';

import { ViewChild } from '@angular/core';
import { Slides } from 'ionic-angular';
/**
 * Generated class for the HistoryThirdPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-history-third',
  templateUrl: 'history-third.html',
})
export class HistoryThirdPage {

  constructor(public navCtrl: NavController, public navParams: NavParams,public alertCtrl:AlertController) {
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad HistoryThirdPage');
  }
  ...
  answers1: String[] = ["Robben Isaland","Gold","Three","Vasco Da Gama","Colored"];
  ...
  addTotal()
  {
    ...
    if(this.count==5)
    {
     const confirm = this.alertCtrl.create({
       ...
       message: 'Congratulations You have passed the first stage.Go to the next Stage?',
       buttons: [
         {
           text: 'Replay',
           handler: () => {
             ...
             console.log(nameArr);
             console.log(this.count)
             this.navCtrl.setRoot(HistoryThirdPage);

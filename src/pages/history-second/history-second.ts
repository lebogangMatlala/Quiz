...
import { HistoryThirdPage } from '../history-third/history-third';
import { HomePage } from '../home/home';

import { ViewChild } from '@angular/core';
import { Slides } from 'ionic-angular';
/**
 * Generated class for the HistorySecondPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-history-second',
  templateUrl: 'history-second.html',
})
export class HistorySecondPage {

  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl:AlertController ) {
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad HistorySecondPage');
  }
  ...
  answers1: String[] = ["Segregation","Civil Rights","Police Brutality","Dr Daniel Malan","Boycott"];
       ...
       buttons: [
         {
           ...
           handler: () => {
             ...
             console.log(nameArr);
             console.log(this.count)
             this.navCtrl.setRoot(HistorySecondPage);

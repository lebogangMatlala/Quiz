...
import { ScienceThirdPage } from '../science-third/science-third';
/**
 * Generated class for the ScienceSecondPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-science-second',
  templateUrl: 'science-second.html',
})
export class ScienceSecondPage {
  ...
  answers1: String[] = ["Kidney","Stomach","Vitamin C","984 Degrees F","Jugular Veins"];
       ...
       buttons: [
         {
           ...
           handler: () => {
             ...
             console.log(nameArr);
             console.log(this.count)
             this.navCtrl.setRoot(ScienceSecondPage);
         ...
         },
         {
           ...
           handler: () => {
             ...
             console.log(nameArr);
             console.log(this.count);
             this.navCtrl.setRoot(ScienceThirdPage);

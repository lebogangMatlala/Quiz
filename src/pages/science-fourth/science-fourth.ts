...
/**
 * Generated class for the ScienceFourthPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-science-fourth',
  templateUrl: 'science-fourth.html',
})
export class ScienceFourthPage {
  ...
  answers1: String[] = ["Ovaries","Liver","Wrist","Patella","Brain"];

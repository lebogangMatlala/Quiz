...
/**
 * Generated class for the NatureForthPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-nature-forth',
  templateUrl: 'nature-forth.html',
})
export class NatureForthPage {
  ...
  answers1: String[] = ["10","4","One","6","Dormant"];

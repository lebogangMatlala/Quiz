...
import { ScienceFourthPage } from '../science-fourth/science-fourth';
/**
 * Generated class for the ScienceThirdPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-science-third',
  templateUrl: 'science-third.html',
})
export class ScienceThirdPage {
  ...
  answers1: String[] = ["Hiccups","Retina","Ear Drum","Erythrocyte","Trachea"];
       ...
       buttons: [
         ...
         },
         {
           ...
           handler: () => {
             ...
             console.log(nameArr);
             console.log(this.count);
             this.navCtrl.setRoot(ScienceFourthPage);

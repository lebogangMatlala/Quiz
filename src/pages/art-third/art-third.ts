...
import { ArtFourthPage } from '../art-fourth/art-fourth';
/**
 * Generated class for the ArtThirdPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-art-third',
  templateUrl: 'art-third.html',
})
export class ArtThirdPage {
  ...
  answers1: String[] = ["2007","36","Ne-Yo and Jhene Aiko","Thandiswa","January 28"];

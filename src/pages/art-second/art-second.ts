...
import { ArtThirdPage } from '../art-third/art-third';
/**
 * Generated class for the ArtSecondPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-art-second',
  templateUrl: 'art-second.html',
})
export class ArtSecondPage {
  ...
  answers1: String[] = ["Caracara","Mafikeng","NN Enterprise","Mafikizolo","Nkosinathi Maphumulo"];
       ...
       buttons: [
         ...
         },
         {
           ...
           handler: () => {
             ...
             console.log(nameArr);
             console.log(this.count);
             this.navCtrl.setRoot(ArtThirdPage);

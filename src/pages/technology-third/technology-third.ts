...
import { TechnologyFourthPage } from '../technology-fourth/technology-fourth';
...
/**
 * Generated class for the TechnologyThirdPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-technology-third',
  templateUrl: 'technology-third.html',
})
export class TechnologyThirdPage {
  ...
  answers1: String[] = ["World Wide Web","In Intranet","Lada","IMAX","A Mouse"];
       ...
       buttons: [
         ...
         },
         {
           ...
           handler: () => {
             ...
             console.log(nameArr);
             console.log(this.count);
             this.navCtrl.setRoot(TechnologyFourthPage);

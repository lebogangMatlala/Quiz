...
/**
 * Generated class for the TechnologyFourthPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-technology-fourth',
  templateUrl: 'technology-fourth.html',
})
export class TechnologyFourthPage {
  ...
  answers1: String[] = ["6","Decode","A URL","8","Field Effect Transistor"];
